...
FunctionsToExport = 'Add-DbOpen', 'Enter-DbTransaction', 'Exit-DbTransaction', 'Get-DbData',
               'Get-DbSmo', 'Get-DbWmi', 'New-DbBulkCopy', 'New-DbCommand',
               'New-DbConnection', 'Use-DbRetry'
